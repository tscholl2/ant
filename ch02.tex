...
\begin{proposition}\iprop{characterization of noetherian}
  ...
  \begin{enumerate}[label=(\alph*)]
    \item\label{itm:noeth1} $M$ is noetherian,
    \item\label{itm:noeth2} $M$ satisfies the ascending chain condition, and
    \item\label{itm:noeth3} Every nonempty set of submodules of $M$ contains at

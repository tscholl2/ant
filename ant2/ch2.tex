...
\begin{example}
The matrix $\begin{matrix} -2 & 2 \\ -3 & 4 \end{matrix}$ has Smith normal form
$\begin{matrix} 1 & 0 \\ 0 & 2 \end{matrix}$,
and the matrix
$\begin{matrix} 1 & 4 & 9 \\ 16 & 25 & 36 \\ 49 & 64 & 81 \end{matrix}$
has Smith normal form
$\begin{matrix} 1 & 0 & 0 \\ 0 & 3 & 0 \\ 0 & 0 & 72 \end{matrix}$.
